...
module BEL
  module Language
    module Version1
      module Signatures
        # TranscriptionalActivityOfProteinAbundance signature.
        class TranscriptionalActivityOfProteinAbundance
          ...
          AST = BEL::Language::Semantics::Builder.build do
            term(
              function(
                identifier(
                  function_of(BEL::Language::Version1::Functions::TranscriptionalActivity))),
              argument(
                term(
                  function(
                    identifier(
