...
describe 'when parsing relationships' do
  ...
  context 'with well-formed, known relationships' do
    rel = 'increases'
    it "is complete for #{rel}" do
      output = parse_ast_no_nl(parser, rel)
