...
::ragel::nfa_kw ragel::factor_rep::nfa_kw() { static int a[] = {1, 1, 0}; return ::ragel::nfa_kw( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
::ragel::uint ragel::factor_rep::uint() { static int a[] = {3, 1, 2, 2, 2, 3, 2}; return ::ragel::uint( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
::ragel::factor_rep ragel::factor_rep::_factor_rep() { static int a[] = {3, 1, 4, 2, 4, 3, 4}; return ::ragel::factor_rep( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
::ragel::action_ref ragel::factor_rep::A1() { static int a[] = {3, 1, 6, 2, 6, 3, 6}; return ::ragel::action_ref( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
::ragel::action_ref ragel::factor_rep::A2() { static int a[] = {3, 1, 8, 2, 8, 3, 8}; return ::ragel::action_ref( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
::ragel::action_ref ragel::factor_rep::A3() { static int a[] = {3, 1, 10, 2, 10, 3, 10}; return ::ragel::action_ref( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
::ragel::action_ref ragel::factor_rep::A4() { static int a[] = {2, 1, 12, 2, 12}; return ::ragel::action_ref( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
::ragel::action_ref ragel::factor_rep::A5() { static int a[] = {1, 1, 14}; return ::ragel::action_ref( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
::ragel::action_ref ragel::factor_rep::A6() { static int a[] = {1, 1, 16}; return ::ragel::action_ref( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
...
::ragel::join ragel::factor::join() { static int a[] = {1, 8, 1}; return ::ragel::join( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
...
::_repeat_import _repeat_import:: next() { return ::_repeat_import( __prg, colm_get_repeat_next( __tree ) ); }
::import _repeat_import:: value() { return ::import( __prg, colm_get_repeat_val( __tree ) ); }
::c_host::_repeat_section c_host::_repeat_section:: next() { return ::c_host::_repeat_section( __prg, colm_get_repeat_next( __tree ) ); }
::c_host::section c_host::_repeat_section:: value() { return ::c_host::section( __prg, colm_get_repeat_val( __tree ) ); }
::ruby_host::_repeat_section ruby_host::_repeat_section:: next() { return ::ruby_host::_repeat_section( __prg, colm_get_repeat_next( __tree ) ); }
::ruby_host::section ruby_host::_repeat_section:: value() { return ::ruby_host::section( __prg, colm_get_repeat_val( __tree ) ); }
::ocaml_host::_repeat_section ocaml_host::_repeat_section:: next() { return ::ocaml_host::_repeat_section( __prg, colm_get_repeat_next( __tree ) ); }
::ocaml_host::section ocaml_host::_repeat_section:: value() { return ::ocaml_host::section( __prg, colm_get_repeat_val( __tree ) ); }
::ragel::_repeat_write_arg ragel::_repeat_write_arg:: next() { return ::ragel::_repeat_write_arg( __prg, colm_get_repeat_next( __tree ) ); }
::ragel::write_arg ragel::_repeat_write_arg:: value() { return ::ragel::write_arg( __prg, colm_get_repeat_val( __tree ) ); }
::ragel::_repeat_statement ragel::_repeat_statement:: next() { return ::ragel::_repeat_statement( __prg, colm_get_repeat_next( __tree ) ); }
::ragel::statement ragel::_repeat_statement:: value() { return ::ragel::statement( __prg, colm_get_repeat_val( __tree ) ); }
::ocaml_inline::_repeat_expr_item ocaml_inline::_repeat_expr_item:: next() { return ::ocaml_inline::_repeat_expr_item( __prg, colm_get_repeat_next( __tree ) ); }
::ocaml_inline::expr_item ocaml_inline::_repeat_expr_item:: value() { return ::ocaml_inline::expr_item( __prg, colm_get_repeat_val( __tree ) ); }
::ocaml_inline::_repeat_block_item ocaml_inline::_repeat_block_item:: next() { return ::ocaml_inline::_repeat_block_item( __prg, colm_get_repeat_next( __tree ) ); }
::ocaml_inline::block_item ocaml_inline::_repeat_block_item:: value() { return ::ocaml_inline::block_item( __prg, colm_get_repeat_val( __tree ) ); }
::ruby_inline::_repeat_expr_item ruby_inline::_repeat_expr_item:: next() { return ::ruby_inline::_repeat_expr_item( __prg, colm_get_repeat_next( __tree ) ); }
::ruby_inline::expr_item ruby_inline::_repeat_expr_item:: value() { return ::ruby_inline::expr_item( __prg, colm_get_repeat_val( __tree ) ); }
::ruby_inline::_repeat_block_item ruby_inline::_repeat_block_item:: next() { return ::ruby_inline::_repeat_block_item( __prg, colm_get_repeat_next( __tree ) ); }
::ruby_inline::block_item ruby_inline::_repeat_block_item:: value() { return ::ruby_inline::block_item( __prg, colm_get_repeat_val( __tree ) ); }
::crack_inline::_repeat_expr_item crack_inline::_repeat_expr_item:: next() { return ::crack_inline::_repeat_expr_item( __prg, colm_get_repeat_next( __tree ) ); }
::crack_inline::expr_item crack_inline::_repeat_expr_item:: value() { return ::crack_inline::expr_item( __prg, colm_get_repeat_val( __tree ) ); }
::crack_inline::_repeat_block_item crack_inline::_repeat_block_item:: next() { return ::crack_inline::_repeat_block_item( __prg, colm_get_repeat_next( __tree ) ); }
::crack_inline::block_item crack_inline::_repeat_block_item:: value() { return ::crack_inline::block_item( __prg, colm_get_repeat_val( __tree ) ); }
::crack_host::_repeat_section crack_host::_repeat_section:: next() { return ::crack_host::_repeat_section( __prg, colm_get_repeat_next( __tree ) ); }
::crack_host::section crack_host::_repeat_section:: value() { return ::crack_host::section( __prg, colm_get_repeat_val( __tree ) ); }
...
::ragel::nfa_kw ragel::_T_factor_rep::nfa_kw() { static int a[] = {1, 1, 0}; return ::ragel::nfa_kw( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
::ragel::uint ragel::_T_factor_rep::uint() { static int a[] = {3, 1, 2, 2, 2, 3, 2}; return ::ragel::uint( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
::ragel::factor_rep ragel::_T_factor_rep::_factor_rep() { static int a[] = {3, 1, 4, 2, 4, 3, 4}; return ::ragel::factor_rep( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
::ragel::action_ref ragel::_T_factor_rep::A1() { static int a[] = {3, 1, 6, 2, 6, 3, 6}; return ::ragel::action_ref( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
::ragel::action_ref ragel::_T_factor_rep::A2() { static int a[] = {3, 1, 8, 2, 8, 3, 8}; return ::ragel::action_ref( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
::ragel::action_ref ragel::_T_factor_rep::A3() { static int a[] = {3, 1, 10, 2, 10, 3, 10}; return ::ragel::action_ref( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
::ragel::action_ref ragel::_T_factor_rep::A4() { static int a[] = {2, 1, 12, 2, 12}; return ::ragel::action_ref( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
::ragel::action_ref ragel::_T_factor_rep::A5() { static int a[] = {1, 1, 14}; return ::ragel::action_ref( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
::ragel::action_ref ragel::_T_factor_rep::A6() { static int a[] = {1, 1, 16}; return ::ragel::action_ref( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
...
::ragel::join ragel::_T_factor::join() { static int a[] = {1, 8, 1}; return ::ragel::join( __prg, colm_get_rhs_val( __prg, __tree, a ) ); }
...
{ return ::start( prg, colm_get_global( prg, 4) ); }
::str RagelError( colm_program *prg )
{ return ::str( prg, colm_get_global( prg, 5) ); }
::_repeat_import RagelImport( colm_program *prg )
{ return ::_repeat_import( prg, colm_get_global( prg, 6) ); }
